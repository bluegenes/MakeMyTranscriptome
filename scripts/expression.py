...
def gen_expression_supervisor(fastq1,fastq2,paired_names,unpaired,unpaired_names,cpu,sample_info,model,dependency_set):
    ...
    salmon_tasks = []
    #salmon_tasks = [gene_trans_map,build_salmon,salmon_gene_map]
    ...
    all_tasks = [fasta_to_bed,build_bowtie,build_salmon,gene_trans_map,salmon_gene_map,counts_to_table_intersect,counts_to_table_express,counts_to_table_salmon, deseq2_intersect,deseq2_express, deseq2_salmon]
