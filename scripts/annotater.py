...
def gen_annotation_supervisor(cpu, uniref90_flag, nr_flag, blast_flag, signalp_flag, tmhmm_flag, rnammer_flag, dependency_set):
    ...
    tasks.append(pfam)
    annot_table_opts = {'geneTransMap': gene_trans_map.targets[0],
                        'transdecoder': predict_orfs.targets[0],
                        'pfam': pfam.targets[0]}
    ...
    if(blast_flag):
        ...
        annot_table_opts['spX'] = blastx_sprot.targets[0]
        ...
        annot_table_opts['spX'] = dmnd_xsprot.targets[0]
        ...
        annot_table_opts['spP'] = dmnd_psprot.targets[0]
        ...
        if(uniref90_flag):
            ...
            annot_table_opts['ur90X'] = dmnd_xur90.targets[0]
            ...
            annot_table_opts['ur90P'] = dmnd_pur90.targets[0]
        if(nr_flag):
            ...
            annot_table_opts['nrX'] = dmnd_xnr.targets[0]
            ...
            annot_table_opts['nrP'] = dmnd_pnr.targets[0]
