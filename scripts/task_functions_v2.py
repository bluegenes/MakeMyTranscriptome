...
PATH_ROOT = '/ni2/tessa_projects/build'
...
PATH_SWISS_PROT = join(PATH_DATABASES,'uniprot_sprot','uniprot_sprot.fasta')
PATH_UNIREF90 = join(PATH_DATABASES,'uniref90','uniref90.fasta')

''' dynamic path variable functions'''
GEN_PATH_DIR = lambda : join(PATH_ASSEMBLIES,NAME_OUT_DIR)
GEN_PATH_ASSEMBLY_FILES = lambda : join(GEN_PATH_DIR(),'assembly_files')
GEN_PATH_ANNOTATION_FILES = lambda : join(GEN_PATH_DIR(),'annotation_files')
GEN_PATH_EXPRESSION_FILES = lambda : join(GEN_PATH_DIR(),'expression_files')
GEN_PATH_LOGS = lambda : join(GEN_PATH_DIR(),'logs')
GEN_PATH_ASSEMBLY = lambda : join(GEN_PATH_DIR(),NAME_ASSEMBLY+'.fasta')
GEN_LOGS = lambda x : (join(GEN_PATH_LOGS(),x+'.out_log'),join(GEN_PATH_LOGS(),x+'.err_log'))
